 ...
 * Created by tiberal on 15.02.17.
...
abstract class BaseFeedLockerController<VM : BaseViewModel>(private val mStub: ViewStubProxy) : ViewStub.OnInflateListener, IFeedLockerView {
    ...
    var lockScreenFactory: ILockScreenVMFactory? = null
    ...
    override fun onInflate(stub: ViewStub?, inflated: View?) {
        ...
        lockScreenFactory?.let { factory ->
            mStub.binding?.let {
                mStubModel = factory.construct() as VM
    ...
    interface ILockScreenVMFactory {
        fun construct(): BaseViewModel
    }
