    ...
    public void onAvatarClick() {
        if (mUser != null) {
            if (!(mUser.deleted || mUser.banned)) {
                startActivity(UserProfileActivity.createIntent(null, mPhoto, mUserId, mUser.feedItemId, false, CacheProfile.premium, Utils.getNameAndAge(mUser.firstName, mUser.age), mUser.city.getName()));
            } else {
