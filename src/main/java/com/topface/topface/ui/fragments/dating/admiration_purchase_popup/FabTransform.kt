 ...
 */
class FabTransform(@ColorInt private val color: Int, @DrawableRes private val icon: Int) : Transition() {
    ...
    override fun createAnimator(sceneRoot: ViewGroup,
        ...
        val fastOutSlowInInterpolator = AnimationUtils.loadInterpolator(sceneRoot.context,
        ...
        if (fromFab) {
            ...
            circularReveal.interpolator = AnimationUtils.loadInterpolator(sceneRoot.context,
        ...
        if (view is ViewGroup) {
            fadeContents = ArrayList<Animator>(view.childCount)
    ...
    companion object {
        ...
        private val PROP_BOUNDS = "admirationPurchasePopup:fabTransform:bounds"
