...
class PurchaseSuccessfullViewModel(private val mFeedNavigator: FeedNavigator, val goTo: String, val sku: String) {
    ...
    fun preparePopupText(balanceData: BalanceData) = popupText.set(if (sku.equals("монеты")) Utils.getQuantityString(R.plurals.you_have_some_coins, balanceData.money)
    ...
    fun preparePopupImage() = if (sku.equals("монеты")) R.drawable.pic_coins else R.drawable.pic_coins  // todo вставить картинку для симпатий
