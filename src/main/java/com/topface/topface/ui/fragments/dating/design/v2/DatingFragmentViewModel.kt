...
import com.topface.topface.ui.fragments.dating.IDatingViewModelEvents
 ...
 */
class DatingFragmentViewModel(private val binding: FragmentDatingV2Binding, private val mApi: FeedApi,
        ...
        BaseViewModel<FragmentDatingV2Binding>(binding), OnUsersListEventsListener<SearchUser> {
