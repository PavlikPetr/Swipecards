...
class TabbedLikesFragment : TabbedFeedFragment() {
    ...
    override fun onBeforeCountersUpdate(countersData: CountersData?) {
        updatePageCounter(LikeFragment::class.java.name, countersData?.likes ?: 0)
    ...
    override fun addPages() {
        addBodyPage(LikeFragment::class.java.name, R.string.general_likes.getString(), mCountersData.likes)
