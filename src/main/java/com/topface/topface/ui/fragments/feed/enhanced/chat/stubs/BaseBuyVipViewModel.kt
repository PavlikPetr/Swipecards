...
abstract class BaseBuyVipViewModel(mFeedUser: FeedUser) {
    ...
    val mutualPlaceholderRes = ObservableInt(if (mFeedUser.sex == User.BOY) R.drawable.dialogues_av_man_big else R.drawable.dialogues_av_girl_big)
