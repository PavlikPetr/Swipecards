...
class PeopleNearbyEmptyLocationComponent : AdapterComponent<ItemEmptyPeopleNearbyBinding, PeopleNearbyEmptyLocation>() {
    ...
    override fun bind(binding: ItemEmptyPeopleNearbyBinding, data: PeopleNearbyEmptyLocation?, position: Int) {
        binding.viewModel = PeopleNearbyEmptyViewModel(R.string.cannot_get_geo.getString())
    }
}