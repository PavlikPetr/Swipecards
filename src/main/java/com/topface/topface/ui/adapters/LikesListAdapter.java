...
public class LikesListAdapter extends FeedAdapter<FeedLike> {
    ...
    protected View getContentView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            holder.heart.setImageResource(like.mutualed ? R.drawable.full_heart_selector :
                    (like.highrate ? R.drawable.im_item_mutual_heart_top : R.drawable.empty_heart_selector));
