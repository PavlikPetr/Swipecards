...
public final class Streams {
    ...
    /**
     * Copies the contents of the given {@link java.io.InputStream}
     * to the given {@link java.io.OutputStream}. Shortcut for
     * <pre>
     *   copy(pInputStream, pOutputStream, new byte[8192]);
     * </pre>
     *
     * @param pInputStream  The input stream, which is being read.
     *                      It is guaranteed, that {@link java.io.InputStream#close()} is called
     *                      on the stream.
     * @param pOutputStream The output stream, to which data should
     *                      be written. May be null, in which case the input streams
     *                      contents are simply discarded.
     * @param pClose        True guarantees, that {@link java.io.OutputStream#close()}
     *                      is called on the stream. False indicates, that only
     *                      {@link java.io.OutputStream#flush()} should be called finally.
