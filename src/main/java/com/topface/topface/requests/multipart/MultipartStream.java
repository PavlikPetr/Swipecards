...
public class MultipartStream {
     ...
     * @see #MultipartStream(java.io.InputStream, byte[],
     ...
     * @see #MultipartStream(java.io.InputStream, byte[], int,
     * MultipartStream.ProgressNotifier)
     */
    MultipartStream(InputStream input,
                    byte[] boundary,
     ...
     * @throws java.io.IOException if there is no more data available.
     */
     ...
     * application.
     * <p/>
     * <p> allow limiting maximum header size to
     ...
     * #MultipartStream(java.io.InputStream, byte[], int,
    ...
    /**
     * An {@link java.io.InputStream} for reading an items contents.
     */
