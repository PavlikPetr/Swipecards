...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public ListPreloader(int maxPreload) {
        this.preloadModelProvider = new com.bumptech.glide.ListPreloader.PreloadModelProvider<T>() {
            @Override
        ...
        this.preloadDimensionProvider = new com.bumptech.glide.ListPreloader.PreloadSizeProvider<T>() {
     ...
     * @param maxPreload               Maximum number of items to preload.
     */
    public ListPreloader(com.bumptech.glide.ListPreloader.PreloadModelProvider<T> preloadModelProvider,
                         com.bumptech.glide.ListPreloader.PreloadSizeProvider<T> preloadDimensionProvider, int maxPreload) {
