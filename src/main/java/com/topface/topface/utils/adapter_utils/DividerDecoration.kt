 ...
 */
class DividerDecoration(val dialogTypeProvider: DialogTypeProvider, dividerColor: Int, strokeWidth: Float, val marginLeft: Float) : RecyclerView.ItemDecoration() {
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val typeWithoutDivider = dialogTypeProvider.getType(AppDayStubItem::class.java)
