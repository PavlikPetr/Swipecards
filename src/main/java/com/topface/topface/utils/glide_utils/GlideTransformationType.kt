...
object GlideTransformationType {
    ...
    @IntDef(CROP_CIRCLE_TYPE, ADMIRATION_TYPE, ADMIRATION_AND_ONLINE_TYPE, ONLINE_CIRCLE_TYPE,BLUR_TYPE)
     ...
     * @param BLUR_TYPE - параметр для выбора transition блюра картинки
     */
