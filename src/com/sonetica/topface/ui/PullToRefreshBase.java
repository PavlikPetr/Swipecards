...
public abstract class PullToRefreshBase<T extends AbsListView> extends LinearLayout implements OnTouchListener, OnScrollListener {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_UP_TO_REFRESH) {
			headerImage.setImageResource(R.drawable.im_pulltorefresh_up_arrow);
			index = 1;
		} else {
			headerImage.setImageResource(R.drawable.im_pulltorefresh_down_arrow);
			index = 0;
		}
