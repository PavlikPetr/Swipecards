...
public class DatingGallery_ extends ViewGroup {
  ...
  private DatingLayout_ mDatingLayout;
  private DatingGalleryAdapter_ mAdapter;
  ...
  //-------------------------------------------------------------------------
  public DatingGallery_(Context context,AttributeSet attrs) {
    super(context,attrs);
    ...
    // фрейм оценок
    mDatingLayout = new DatingLayout_(context);
  ...
  //---------------------------------------------------------------------------
  public void setAdapter(DatingGalleryAdapter_ adapter) {
    mAdapter = adapter;
  }
  //---------------------------------------------------------------------------
