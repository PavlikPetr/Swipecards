...
public class Static {
  ...
  //public static final String API_URL = "http://api.topface.ru/?v=";
  public static final String API_URL = "http://api.beta.topface.ru/?v="; //Beta API URL
  ...
  public static final String PREFERENCES_RATING = "app_rating";
  // Profile
