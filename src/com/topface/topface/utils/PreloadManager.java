...
public class PreloadManager {
    ...
    public void preloadPhoto (SearchUser nextUser) {
        preloadNextPhoto(nextUser.photos.getFirst());
    }
    ...
    public void preloadPhoto (Photo photo) {
        preloadNextPhoto(photo); //TODO: Этот код какой-то неправильный, надо что-то придумать
    }
