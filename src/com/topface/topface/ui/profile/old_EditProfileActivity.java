...
public class old_EditProfileActivity extends PreferenceActivity {
    // Data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        height.setSummary(CacheProfile.form_height > 0 ? "" + CacheProfile.form_height : "");
        ...
        weight.setSummary(CacheProfile.form_weight > 0 ? "" + CacheProfile.form_weight : "");
        ...
        fitness.setSummary(mFormInfo.getFitness(CacheProfile.form_fitness_id));
        ...
        marriage.setSummary(mFormInfo.getMarriage(CacheProfile.form_marriage_id));
        ...
        education.setSummary(mFormInfo.getEducation(CacheProfile.form_education_id));
        ...
        finances.setSummary(mFormInfo.getFinances(CacheProfile.form_finances_id));
        ...
        smoking.setSummary(mFormInfo.getSmoking(CacheProfile.form_smoking_id));
        ...
        alcohol.setSummary(mFormInfo.getAlcohol(CacheProfile.form_alcohol_id));
        ...
        commutability.setSummary(mFormInfo.getCommunication(CacheProfile.form_communication_id));
        ...
        character.setSummary(mFormInfo.getCharacter(CacheProfile.form_character_id));
            	...
            	runOnUiThread(new Runnable() {
					...
					public void run() {
						if (!confirm.completed) {
		            		Toast.makeText(old_EditProfileActivity.this, getString(R.string.general_server_error), Toast.LENGTH_SHORT).show();
		            	}
					}
				});
            }
    ...
    Preference.OnPreferenceClickListener mOnNameListener = new Preference.OnPreferenceClickListener() {
        public boolean onPreferenceClick(final Preference preference) {
            View view = LayoutInflater.from(old_EditProfileActivity.this.getApplicationContext()).inflate(R.layout.pref_edit, null);
            final EditText editBox = (EditText)view.findViewById(R.id.etProfileInput);
            editBox.setText(preference.getSummary());
            AlertDialog.Builder builder = new AlertDialog.Builder(old_EditProfileActivity.this);
    ...
    Preference.OnPreferenceClickListener mOnAgeListener = new Preference.OnPreferenceClickListener() {
        public boolean onPreferenceClick(final Preference preference) {
            ...
            View view = LayoutInflater.from(old_EditProfileActivity.this.getApplicationContext()).inflate(R.layout.pref_age_one_picker, null);
    ...
    Preference.OnPreferenceClickListener mOnCityListener = new Preference.OnPreferenceClickListener() {
        public boolean onPreferenceClick(final Preference preference) {
            Intent intent = new Intent(old_EditProfileActivity.this.getApplicationContext(), CitySearchActivity.class);
        ...
        public boolean onPreferenceClick(final Preference preference) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface arg0,int arg1) {
                    ...
                    preference.setSummary("" + value);
                    CacheProfile.form_height = value;
        ...
        public boolean onPreferenceClick(final Preference preference) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface arg0,int arg1) {
                    ...
                    Integer value = Integer.parseInt(editBox.getText().toString());
                    preference.setSummary("" + value);
                    CacheProfile.form_weight = value;
    ...
    Preference.OnPreferenceChangeListener mOnFitnessListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_fitness_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnMarriageListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_marriage_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnEducationListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_education_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnFinancesListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_finances_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnSmokingListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_smoking_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnAlcoholListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_alcohol_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnCommutabilityListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_communication_id = i;
    ...
    Preference.OnPreferenceChangeListener mOnCharacterListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference,Object newValue) {
            ...
            preference.setSummary(value);
            CacheProfile.form_character_id = i;
