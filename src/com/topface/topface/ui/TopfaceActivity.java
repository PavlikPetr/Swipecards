...
public class TopfaceActivity extends ActivityGroup {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // Animation
    mStartAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,0.0f,
    ...
    // Back
    mBackAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,0.7f,
                                            Animation.RELATIVE_TO_PARENT,0.0f,
                                            Animation.RELATIVE_TO_PARENT,0.0f,
                                            Animation.RELATIVE_TO_PARENT,0.0f);
    ...
    // Hide
    mHideFrameAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,0.7f,
    ...
    // Back Frame
    mBackFrameAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,1.0f,
                                                 Animation.RELATIVE_TO_PARENT,0.0f,
                                                 Animation.RELATIVE_TO_PARENT,0.0f,
                                                 Animation.RELATIVE_TO_PARENT,0.0f);
