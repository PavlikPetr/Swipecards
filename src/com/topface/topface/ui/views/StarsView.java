...
public class StarsView extends View implements View.OnTouchListener {
    ...
    protected void onLayout(boolean changed,int left,int top,int right,int bottom) {
        ...
        mStars[0] = new Star(x, y, star_w, star_h, 10);
        y += star_h; // смещение для отрисовки следующей звезды
        mStars[1] = new Star(x, y, star_w, star_h, 9);
        y += star_h;
        mStars[2] = new Star(x, y, star_w, star_h, 8);
        y += star_h;
        mStars[3] = new Star(x, y, star_w, star_h, 7);
        y += star_h;
        mStars[4] = new Star(x, y, star_w, star_h, 6);
        y += star_h;
        mStars[5] = new Star(x, y, star_w, star_h, 5);
        y += star_h;
        mStars[6] = new Star(x, y, star_w, star_h, 4);
        y += star_h;
        mStars[7] = new Star(x, y, star_w, star_h, 3);
        y += star_h;
        mStars[8] = new Star(x, y, star_w, star_h, 2);
        y += star_h;
