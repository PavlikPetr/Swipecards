  ...
  public void execOld() {
    ...
    //mThreadsPool.execute(new Runnable() {
      ...
      public void run() {
        ...
        //rawResponse = Http.httpRequest(Http.HTTP_POST_REQUEST, Static.API_URL, ApiRequest.this.toString(), null,null);
  ...
  Thread t = new Thread(new Runnable() {
    ...
    public void run() {
      ...
      try {
        ...
        connection.setRequestProperty("Content-Length", "" +Integer.toString(ApiRequest.this.toString().getBytes().length));
...
public void exec() {
  ...
  Thread t = new Thread(new Runnable() {
    ...
    public void run() {
      ...
      mHttpPost.setHeader("Accept", "text/html,application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,* / *;q=0.5");
      ...
      try {
        mHttpPost.setEntity(new ByteArrayEntity(ApiRequest.this.toString().getBytes("UTF8")));
